...
if __name__ == '__main__':
	...
	parser.add_argument('--data-root', type=str, default='/mnt/4t/hico')
	parser.add_argument('--cache-dir', type=str, default='/mnt/4t/hico/detections')
